...
fun myProfile() {
    ...
    val namdep: String = "Dheaa"

    // Variabel untuk menyimpan nama belakang
    val nambel: String = "Fajrianii"
 ...
 */
fun myTeam(): List<Any> {
    val endgame = listOf<String>("dhea","angelika","resta","awaludin","luvy","arya","iqbal","abdullah",
        "nayandra","ibnu","rifki" )
...
fun totalMember(): Int {
    ...
    val countOfGroup = arrayOf<String>("dhea","angelika","resta","awaludin","luvy","arya","iqbal","abdullah",
        "nayandra","ibnu","rifki")
...
fun main() {
     ...
     *
     */
    groupDetail("Marge2", listOf("dhea","angelika","resta","awaludin","luvy","arya","iqbal","abdullah",
